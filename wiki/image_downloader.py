...
def download_pet_sprite(pet_name: str, image_url: str, output_dir: str = "./wiki/output/images/pets") -> Optional[str]:
    """
    下载宠物立绘图片
...
def download_skill_icon(skill_name: str, image_url: str, output_dir: str = "./wiki/output/images/skills") -> Optional[str]:
    """
    下载技能图标图片
...
def download_item_image(item_name: str, image_url: str, category: str = "其他", base_dir: str = "./wiki/output/images/items") -> Optional[str]:
    """
    下载道具图片（按分类组织目录）
...
if __name__ == "__main__":
    ...
    result = download_image(test_url, "./wiki/output/images/test")
    print(f"下载结果: {result}")
